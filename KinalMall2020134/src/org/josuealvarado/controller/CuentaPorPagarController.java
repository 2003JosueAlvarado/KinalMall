...
import org.josuealvarado.bean.CuentaPorPagar;
...
public class CuentaPorPagarController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fechaLimite.getStylesheets().add("/org/josuealvarado/resource/DatePicker.css");
        cargarDatos();
    ...
    public void seleccionarElemento(){
      if(tblCuentasPorPagar.getSelectionModel().getSelectedItem()!=null){  
        ...
        txtNumeroFactura.setText(String.valueOf(((CuentaPorPagar)tblCuentasPorPagar.getSelectionModel().getSelectedItem()).getNumeroFactura()));
        ...
        txtEstadoPago.setText(String.valueOf(((CuentaPorPagar)tblCuentasPorPagar.getSelectionModel().getSelectedItem()).getEstadoPago()));
